...
public class TestContactActivity extends Activity implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		// TODO click listview item
		System.out.println("nicks[position]"+nicks[position]);
	}
